...
class ScraperTests(TestCase):
    ...
    def test_scrape_sets_urls_from_theme_success(self):
        ...
        urls = self.scraper.scrape_sets_urls_from_theme(
            "https://www.lego.com/pl-pl/themes/speed-champions"
        )

        self.assertIn(
            "https://www.lego.com/pl-pl/product/007-aston-martin-db5-76911", urls
        )
